...
class InsecureFirewall(app_manager.RyuApp):
    OFP_VERSIONS = [ofproto_v1_3.OFP_VERSION]
    
    inner_policy = {}

    def __init__(self, *args, **kwargs):
        super(InsecureFirewall, self).__init__(*args, **kwargs)
        self.mac_to_port = {}
        ...
        try:
            ...
            if(out_port != ofproto.OFPP_FLOOD) and (ethtype == ETH_TYPE_IP):
                ...
                #Check for TCP SYN ONLY.
                    ...
                    # All remaining TCP packets should be forwarded.
                    else:
                        actions_default = action_fwd_to_out_port
